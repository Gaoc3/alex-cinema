...
with socket.create_connection(('127.0.0.1', 8083)) as sock:
    with context.wrap_socket(sock, server_hostname='cndw2.shabakaty.com') as ssock:
...
cmd = f"dbclient -y -y -i /etc/dropbear/id_rsa root@64.225.99.144 'echo {b64_script} | base64 -d > /tmp/test_cndw2.py && python3 /tmp/test_cndw2.py'"
