  ...
  return (
    <div className="flex flex-col gap-8 w-full max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-12 gap-8 items-stretch">
        ...
        {/* Video Player (lg:col-span-9) */}
        <div className="col-span-12 lg:col-span-9 flex flex-col justify-stretch">
          <div className="bg-black rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.6)] border border-white/10 relative group transition-all duration-300 hover:border-alex-primary/30 h-full flex flex-col justify-center">
            {isLoadingStreams ? (
      ...
      <div className="grid grid-cols-12 gap-8 items-stretch">
        ...
        {/* Additional Info Card (lg:col-span-3) */}
        <div className="col-span-12 lg:col-span-3 flex flex-col">
