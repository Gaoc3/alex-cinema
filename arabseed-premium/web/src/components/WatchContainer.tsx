...
export default function WatchContainer({ video, seasons, episodes }: WatchContainerProps) {
  ...
  return (
    <div className="flex flex-col gap-10 w-full">
      ...
      {/* Top Main Stage - Video Player (Full Width) */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full max-w-7xl mx-auto">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 glass-panel p-5 rounded-2xl shadow-lg border border-white/5">
            ...
            <div className="flex items-center gap-3">
              <button 
                ...
                className={`flex items-center gap-2.5 text-sm font-bold px-4 py-2.5 rounded-xl border transition-all hover-scale cursor-pointer ${
                  userVote === 'like'
          ...
          <div className="glass-panel rounded-3xl p-8 md:p-10 shadow-xl relative overflow-hidden border border-white/5">
            ...
            <div className="mt-10 border-t pt-10 border-white/10 relative z-10">
          ...
          {isSeries && episodes.length > 0 && (
            <div className="glass-panel rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden border border-white/5">
              ...
              {/* Seasons selector */}
              {seasons.length > 1 && (
                <div className="flex flex-wrap gap-2 pb-6 border-b border-white/5 mb-6 relative z-10">
                  {seasons.map((s) => (
                    <button
                      key={s.season}
