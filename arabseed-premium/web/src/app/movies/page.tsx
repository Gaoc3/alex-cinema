...
function MoviesContent() {
  ...
  useEffect(() => {
    async function loadMovies() {
      ...
      const searchUrl1 = `/api/proxy?endpoint=AdvancedSearch&level=1&videoTitle=&staffTitle=&page=${apiPage1}&year=${yearRange}&type=movies${catParam}${starParam}`;
      const searchUrl2 = `/api/proxy?endpoint=AdvancedSearch&level=1&videoTitle=&staffTitle=&page=${apiPage2}&year=${yearRange}&type=movies${catParam}${starParam}`;
