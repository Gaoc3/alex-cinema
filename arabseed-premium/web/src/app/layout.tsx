  ...
  return (
    <html lang="ar" dir="rtl" className={`${cairo.variable} ${outfit.variable}`} suppressHydrationWarning>
      ...
      <body className="antialiased min-h-screen flex flex-col font-sans" suppressHydrationWarning>
          ...
          <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between h-24">
                  <div className="flex items-center gap-12">
                      <Link href="/" className="flex lg:hidden items-center gap-3.5 group hover-scale">
                          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#e50914] to-[#8a0006] flex items-center justify-center shadow-[0_0_20px_rgba(229,9,20,0.5)] group-hover:shadow-[0_0_30px_rgba(229,9,20,0.8)] transition-all duration-300">
                              <i className="fa-solid fa-play text-white ml-1 text-lg"></i>
                          </div>
                          <div className="flex flex-col leading-none">
                              <span className="text-3xl font-black font-en tracking-wider text-white drop-shadow-md">ALEX<span className="text-alex-primary">CINEMA</span></span>
                              <span className="text-xs text-gray-400 font-bold tracking-[0.15em] mt-1.5 uppercase opacity-80">Premium Platform</span>
                          </div>
                      </Link>
                  </div>
                  ...
                  <div className="flex items-center gap-6">
                      <SearchBar />
                      <button className="w-12 h-12 rounded-full glass-panel border border-white/10 flex items-center justify-center hover:bg-white/10 hover:text-alex-primary transition-all hover-scale shadow-lg">
                          <i className="fa-regular fa-bell text-gray-300 text-lg"></i>
                      </button>
                      <button className="hidden sm:flex w-12 h-12 rounded-full border-2 border-alex-primary/50 overflow-hidden hover:border-alex-primary transition-all hover-scale shadow-[0_0_15px_rgba(229,9,20,0.3)]">
        ...
        {/* Main Content */}
        <main className="flex-grow lg:pr-72">
          {children}
        </main>
