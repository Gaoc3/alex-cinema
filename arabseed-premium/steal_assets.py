...
router_tunnel = f'https://mtskycinemana.serveousercontent.com/cgi-bin/api?url={urllib.parse.quote(target_url)}'
...
for link in soup.find_all('link', rel='stylesheet'):
    ...
    if href and href.endswith('.css'):
        ...
        css_tunnel = f'https://mtskycinemana.serveousercontent.com/cgi-bin/api?url={urllib.parse.quote(href)}'
        try:
...
for script in soup.find_all('script', src=True):
    ...
    if src and src.endswith('.js'):
        ...
        js_tunnel = f'https://mtskycinemana.serveousercontent.com/cgi-bin/api?url={urllib.parse.quote(src)}'
        try:
