...
# The stream URL from my previous output
...
command = f'dbclient -y -y -i /etc/dropbear/id_rsa root@64.225.99.144 "curl -s -v -H \'Host: cndw2.shabakaty.com\' -H \'User-Agent: Mozilla/5.0\' -H \'Referer: https://cinemana.shabakaty.com/\' \'{url}\' -k -r 0-1000 -o /dev/null"'
