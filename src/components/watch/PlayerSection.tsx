...
export default function PlayerSection({
  ...
  return (
    <div className="bg-black sm:rounded-3xl overflow-hidden sm:shadow-[0_20px_50px_rgba(0,0,0,0.6)] sm:border sm:border-white/10 relative group transition-all duration-300 sm:hover:border-alex-primary/30 w-full sm:h-full flex flex-col justify-center sm:min-h-[300px] lg:min-h-[350px]">
      {isLoadingStreams ? (
