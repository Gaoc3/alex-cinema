        ...
        {activeSkipKind && (!roomHook || isHost) && (
          ...
          >
            <button
              ...
              className="flex items-center justify-center gap-2.5 bg-black/70 backdrop-blur-md hover:bg-black/85 text-white font-black text-xs md:text-sm px-4 md:px-5 py-2.5 rounded-xl border border-white/20 hover:border-white/40 hover:scale-[1.03] active:scale-95 shadow-[0_4px_20px_rgba(0,0,0,0.5)] transition-all duration-300 cursor-pointer outline-none focus:outline-none ring-0 leading-none whitespace-nowrap"
            >
